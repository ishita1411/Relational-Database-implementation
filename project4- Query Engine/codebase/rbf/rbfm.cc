...
void RecordBasedFileManager::find_free_space(unsigned short recordLen,
		unsigned pageNum, void* page, void* newRecord, RID& rid) {
...
RC RecordBasedFileManager::insertRecord(FileHandle &fileHandle,
    ...
    if(flag==true)
    {
		find_free_space(recordLen, pageNum, page, newRecord, rid);
        //Write to file
        RC r = fileHandle.writePage(pageNum, page);
        free(page);
        free(newRecord);
